...
$query = "
    ...
    AND (a.data_agenda >= CURDATE() and aprovada != 'Concluída')
...
<body>
    <div class="container">
        ...
        <h2>Atenção, se sua agenda está com aprovação pendente, entre em contato com o executor.</h2>
        <h3>As agendas em horário comercial, durante os dias úteis, são aprovadas instantaneamente.</h3>
        
        <?php if ($result && mysqli_num_rows($result) > 0): ?>
            <table class="agenda-table">
                <thead>
                    <tr>
                        <th class="tooltip">Executor
                            <span class="tooltip-text">Pessoa que vai realizar o serviço</span>
                        </th>
                        <th class="tooltip">Dados do serviço
                            <span class="tooltip-text">Informações do serviço a ser realizado</span>
                        </th>
                        <th>Crianda dia:</th>
                        <th class="tooltip">Realizar dia:
                            <span class="tooltip-text">Data e hora que será realizado o serviço</span>
                        </th>
                        <th class="tooltip">Duração
                            <span class="tooltip-text">Duração estimada para a execução do serviço</span>
                        </th>
                        <th class="tooltip">Materiais
                            <span class="tooltip-text">Materiais necessários para a execução do serviço</span>
                        </th>
                        <th class="tooltip">Técnico local
                            <span class="tooltip-text">Pessoa que estará no local, caso o executor precise</span>
                        </th>
                        <th class="tooltip">Conclusão
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        ...
                        ?>
                            ...
                            <td>
                                <?php if ($row['aprovada'] != 'Concluída') : ?>
                                    <a href="agenda_front.php?id=<?php echo $row['id']; ?>">
