...
$query = "
    SELECT a.*, u.username AS cliente_username, u.nome_empresa
    FROM agenda a
    LEFT JOIN usuarios u ON a.id_usuario_cliente = u.id
    WHERE a.id_usuario_tecnico = $usuario_id
    AND a.data_agenda >= CURDATE() and a.aprovada != 'Concluída'
...
<div id="loading-container" style="display:none;">
    ...
    <div class="container">
        <h1>Tarefas para eu executar</h1>
            ...
            <table class="agenda-table">
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        ...
                        ?>
                            <td><?php echo htmlspecialchars($row['cliente_username']).' - '.$row['nome_empresa'].' - '.$row['aprovada']; ?></td>
