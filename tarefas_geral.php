...
<div id="loading-container" style="display:none;">
    ...
    <div class="container">
        <h1>Tarefas geral para executar</h1>
            ...
            <table class="agenda-table">
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        ...
                        ?>
                            <td><?php echo htmlspecialchars($row['cliente_username']).' - '.$row['nome_empresa'].' - '.$row['tecnico_username'].' - '.$row['aprovada']; ?></td>
